              ...
              <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtCustomername" ErrorMessage="Must be required" ValidationGroup="h"></asp:RequiredFieldValidator>
                </div>
                            </div>
                        </div>
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TxtPhoneNo" ErrorMessage="Invalid Phone Number" ValidationExpression="\d{10}" ValidationGroup="h"></asp:RegularExpressionValidator>
                    ...
                    <div class="row">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtEmail" ErrorMessage="Invalid Email address" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="h"></asp:RegularExpressionValidator>
                                 </div>
                        </div>
                        </div>
                     <div class="row">
                        <div class="col-md-2">
                             <div class="form-group">
                                  <asp:Button ID="BtnAdd" runat="server" Text="Add" OnClick="BtnAdd_Click" CssClass="form-control btn btn-outline-primary" ValidationGroup="h" />
                                 </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
